...
docker-compose -f docker-compose.simple.yml --env-file .env.local up -d --build
...
echo "   Logs:    docker-compose -f docker-compose.simple.yml --env-file .env.production logs -f"
echo "   Restart: docker-compose -f docker-compose.simple.yml --env-file .env.production restart"
echo "   Stop:    docker-compose -f docker-compose.simple.yml --env-file .env.production down"
echo ""