...
if [ ! -f "ssl/fullchain.pem" ]; then
    ...
    echo "sudo certbot certonly --standalone -d drum4fun.club -d www.drum4fun.club"
    echo "sudo cp /etc/letsencrypt/live/drum4fun.club/fullchain.pem ./ssl/"
    echo "sudo cp /etc/letsencrypt/live/drum4fun.club/privkey.pem ./ssl/"
